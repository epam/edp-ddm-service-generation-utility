...
class NestedServiceScopeFactoryTest {

  private NestedServiceScopeFactory nestedServiceScopeFactory;
  ...
  @BeforeEach
  void beforeEach() {
    nestedServiceScopeFactory = new NestedServiceScopeFactory(nestedStructureProvider);
  }

  @Test
  void expectValidServiceScopeIsCreated() {
