...
class PartialUpdateServiceScopeFactoryTest {
  ...
  private PartialUpdateServiceScopeFactory instance;

  private Context context = getContext();

  @BeforeEach
  void setup() {
    instance = new PartialUpdateServiceScopeFactory(partialUpdateProvider);
  ...
  void shouldCreateControllerScope() {
    ...
    var resultScope = findByStringContains("MyTable", UpdateServiceScope::getSchemaName, resultList);

    assertThat(resultScope.getClassName()).isEqualTo("MyTableMyTableUpdUpdateService");
    ...
    assertThat(resultScope.getRequestType()).isEqualTo("update-my-table-my-table-upd");
  }
}
