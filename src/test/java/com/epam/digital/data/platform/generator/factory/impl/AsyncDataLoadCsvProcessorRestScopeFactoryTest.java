...
import com.epam.digital.data.platform.generator.factory.impl.asyncload.AsyncDataLoadCsvProcessorRestScopeFactory;
...
class AsyncDataLoadCsvProcessorRestScopeFactoryTest {


  private static final String LIMIT = "100";
  private AsyncDataLoadCsvProcessorRestScopeFactory instance;
  ...
  @BeforeEach
  void beforeEach() {
    instance = new AsyncDataLoadCsvProcessorRestScopeFactory(asyncDataLoadInfoProvider,
  ...
  void expectValidScopeIsCreated() {
    ...
    assertThat(expectedScopes.get(0).getClassName()).isEqualTo(
        "TestSchemaAsyncDataLoadCsvProcessor");
    assertThat(expectedScopes.get(0).getCsvRowSchemaName()).isEqualTo("TestSchemaModel");
    assertThat(expectedScopes.get(0).getCsvPayloadSchemaName()).isEqualTo(
        "TestSchemaModelArrayCsv");
  }
}