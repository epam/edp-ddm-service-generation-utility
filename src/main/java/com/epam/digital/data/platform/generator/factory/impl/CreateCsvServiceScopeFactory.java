...
@Component
public class CreateCsvServiceScopeFactory extends AbstractScope<CreateServiceScope> {

  private final BulkLoadInfoProvider bulkLoadInfoProvider;

  public CreateCsvServiceScopeFactory(
    ...
    return bulkLoadInfoProvider.getTablesWithBulkLoad().stream()
        .map(
            tableName -> {
              ...
              scope.setClassName(getSchemaName(table) + "CreateCsvService");
  ...
  public String getPath() {
    return "rest-api/src/main/java/restapi/service/createCsv.java.ftl";
  }
}
