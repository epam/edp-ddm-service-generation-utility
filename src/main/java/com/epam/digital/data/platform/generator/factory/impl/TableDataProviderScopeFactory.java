...
import com.epam.digital.data.platform.generator.scope.TableDataProviderScope;
...
public class TableDataProviderScopeFactory extends CrudAbstractScope<TableDataProviderScope> {
  ...
  protected TableDataProviderScope map(Table table, Context context) {
    var scope = new TableDataProviderScope();
    scope.setClassName(getSchemaName(table) + "TableDataProvider");
